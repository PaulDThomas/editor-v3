...
export const App = (): JSX.Element => {
  ...
  const [input2, setInput2] = useState<string>(
    // `<div classname="aie-text" data-key="10tu7" data-type="unstyled" data-inline-style-ranges='[{"offset":0,"length":72,"style":"Notes"}]'><span classname="Notes" style="color:royalblue">The &apos;Total&apos; column is compulsory if more than 1 treatment group is used.</span></div><div classname="aie-text" data-key="frng6" data-type="unstyled" data-inline-style-ranges='[{"offset":0,"length":92,"style":"Notes"}]'><span classname="Notes" style="color:royalblue">Timepoint could be days, weeks or visits. Permissable to only present selected (key) visits.</span></div>`,
    // `<div classname="aie-text" data-key="2usqj" data-type="unstyled" data-inline-style-ranges="[]">Scatter plot of eGFR values post randomization, with LOESS smoothing line overlayed.</div>` +
    //   `<div classname="aie-text" data-key="8uaa4" data-type="unstyled" data-inline-style-ranges="[]"></div>` +
    //   `<div classname="aie-text" data-key="5mj3a" data-type="unstyled" data-inline-style-ranges="[]">Y-axis label: eGFR (ml/min/1.73^2)</div>` +
    //   `<div classname="aie-text" data-key="ebhpo" data-type="unstyled" data-inline-style-ranges="[]">X-axis label: Time since randomization (months)</div>` +
    //   `<div classname="aie-text" data-key="fafoq" data-type="unstyled" data-inline-style-ranges="[]"></div>` +
    //   `<div classname="aie-text" data-key="bs8eq" data-type="unstyled" data-inline-style-ranges="[]">Separate plots for SZC and Placebo arm; LOESS line should have 95% Confidence interval included too.</div>` +
    //   `<div classname="aie-text" data-key="14o5e" data-type="unstyled" data-inline-style-ranges="[]"></div>`,
